...
CREATE INDEX IF NOT EXISTS idx_tender_users_company ON tender_users(company_id);
...
-- ============================================
CREATE OR REPLACE FUNCTION tender_update_user_password(
  p_user_id UUID,
  p_old_password TEXT,
  p_new_password TEXT
)
...
-- RLS policies would need to be implemented based on your application's
-- session management. For now, we'll create basic policies that can be
-- customized based on how you manage user sessions.

-- Create policy for companies (allow all for now, customize based on your needs)
...
-- Create policies for users (allow all for now, customize based on your needs)
...
-- Create policies for tenders (allow all for now, customize based on your needs)
...
-- Create policies for history (allow all for now, customize based on your needs)
...
-- Note: Adjust these based on your Supabase configuration
